...
# dictionary of lists  
dict = {'name': name, 'mailid' :mail_id , 'password': pass1}  

df = pd.DataFrame(dict) 
df=df1.append(df)# saving the dataframe 
df.to_csv('Database.csv',index=False) 

ret=face_collect(nam)
